...
var Handsontable = window.Handsontable = function (rootElement, userSettings) {
...
(function (Handsontable) {
  ...
  DateEditor.prototype.init = function () {
    ...
    if(typeof jQuery != 'undefined') {
      ...
      throw new Error("You need to include jQuery to your project in order to use the Bootstrap Datepicker.");
    }
  ...
  DateEditor.prototype.showDatepicker = function () {
    ...
    var scrollLeft = Handsontable.Dom.getScrollLeft(this.instance.rootElement);
    var scrollTop = Handsontable.Dom.getScrollTop(this.instance.rootElement);
    this.datePickerStyle.top = (offset.top - scrollTop + 1) + 'px';
    this.datePickerStyle.left = (offset.left - scrollLeft +1) + 'px';
